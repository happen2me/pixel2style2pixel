...
class TrainOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--output_nc', default=3, type=int, help='Number of output channels of generator')
		...
		self.parser.add_argument('--load_partial_weights', action='store_true', help='Whether to load partial weights')
